                ...
                <h4 class="card-header header2">LOGIN</h4>
                    <div class="card-text"> 
                        ...
                        <ul class="list-group list-group-flush" >
                         <li class="list-group-item"><b style="float: left;">Phone Number :</b><input id="input1" type="text" name="phoneNumber" placeholder="phoneNumber"  required onkeyup='check();' style="width:100%;border:none;"></li>
